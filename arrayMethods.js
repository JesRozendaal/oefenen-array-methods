...
const invertorsSixtheenthCentury = inventors.filter((inventor) => {
  return inventor.year >= 1500 && inventor.year < 1600;
})
console.log(invertorsSixtheenthCentury);

// KORTERE VERSIE (optioneel):
// const inventorsSixtheenthCentury = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1600);
...
// KORTERE VERSIE (optioneel):
// const yearOfBirth = inventors.map(inventor => inventor.year);
...
const nameInvertors = inventors.map((inventor) => {
  return inventor.first + " " + inventor.last;
})

console.log(nameInvertors);
